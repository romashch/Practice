...
namespace SurfClub.Models
{
    public class User
    {
        ...
        [RegularExpression(@"[a-zA-Zа-яА-Я0-9_]{3,20}", ErrorMessage = "Псевдоним может содержать от 3 до 20 символов. Латиница, кириллица, цифры и подчёркивания")]
        ...
        [RegularExpression(@"[a-zA-Zа-яА-Я0-9_]{6,20}", ErrorMessage = "Пароль может содержать от 6 до 20 символов. Латиница, цифры и подчёркивания")]
        [Display(Name = "Пароль*")]
